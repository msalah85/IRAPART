...
namespace IRACMS.Web.Host.Utilities
{
    /// <summary>
    /// Summary description for LZStringUpdated
    /// </summary>
    public static class LZStringUpdated
    {
        ...
        static Context_Compress_Data writeBit(int value, Context_Compress_Data data)
        {
        ...
        static Context_Compress_Data writeBits(int numbits, int value, Context_Compress_Data data)
        {
        ...
        static Context_Compress produceW(Context_Compress context)
        {
        ...
        static Context_Compress decrementEnlargeIn(Context_Compress context)
        {
        ...
        static int readBit(Decompress_Data data)
        {
        ...
        static int readBits(int numBits, Decompress_Data data)
        {
